...
class ContabilidadController extends Controller
{
    ...
    {   
        ...
        return view('contabilidad',compact('total'));
    }       
    ...
    public function store(Request $request)
    {
        ...
        $arr = $cont->registros_fechas($inicio,$final);
    ...
    {
        $cont = "SELECT b.nombre banca, b.id banca_id, t.id ticket_id , a.ganador ganador ,a.monto monto,a.dia dia,an.nombre animalito,s.hora hora,lt.nombre loteria, an.imagen imagen FROM users u,bancas b,tickets t,apuestas a , loterias lt ,sorteos s ,animalitos an  where u.id = ? and u.id = b.user_id and b.id = t.banca_id and t.id = a.ticket_id and a.dia = ? and lt.id = a.loteria_id and s.id = a.sorteo_id and an.id = a.animalito_id";

        return DB::select($cont,[Auth::id(),$dia]);
